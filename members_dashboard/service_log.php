<?php 
      ...
      //Query
        ...
        $stmt = $conn->prepare("SELECT * FROM service_submissions WHERE user_id = ? ORDER BY service_date DESC");
          ...
          <div class="col-sm-8 text-center main-content">
            ...
            ?>
              ...
              <tr>
                ...
                <th class="col-sm-2 text-center">Organization Type</th>
                <th class="col-sm-2 text-center">Service Type</th>
              ...
              <?php
                ...
                while($row = $result->fetch_assoc())
                {
                  ...
                  <tr class="<?php echo ($i % 2 == 0 ? 'other-row' : '' ); ?>">
                    ...
                    <td class="col-sm-2 text-center"><?php echo ($row["org_type"] == "Other" ? $row["org_type_other"] : $row["org_type"]);?></td>
                    <td class="col-sm-2 text-center"><?php echo ($row["service_type"] == "Other" ? $row["service_type_other"] : $row["service_type"]);?></td>
